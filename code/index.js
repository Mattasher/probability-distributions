 ...
 */
export function rbeta(n, alpha, beta, loc) {
 ...
 */
export function rbinom(n, size, p) {
    n = this._v(n, "n");
 ...
 * @returns {Array} Random variates array
 */
export function rcauchy(n, loc, scale) {
    n = this._v(n, "n");
    loc = this._v(loc, "r", 0);
 ...
 * @returns {Array} Random variates array
 */
export function rchisq(n, df, ncp) {
    n = this._v(n, "n");
    df = this._v(df, "nn");
    ncp = this._v(ncp, "r", 0);
 ...
 * @returns {Array}
 */
export function rint(n, min, max, inclusive) {
    n = this._v(n, "n");
    min = this._v(min, "int");
    max = this._v(max, "int");
    if(inclusive === false) {
 ...
 * @returns {Array} Random variates array
 */
export function rlaplace(n, loc, scale) {
    n = this._v(n, "n");
    loc = this._v(loc, "r", 0);
    scale = this._v(scale, "nn", 1);
 ...
 * @returns {Array} Random variates array
 */
export function rlnorm(n, meanlog, sdlog) {
    n = this._v(n, "n");
 ...
 * @returns {Array} Random variates array
 */
export function rnbinom(n, size, p, mu) {
    n = this._v(n, "n");
 ...
 * @returns {Number} The density given the parameter values
 */
export function dnorm(x, mean, sd) {
    x = this._v(x, "r");
 ...
 * @returns {Array} Random variates array
 */
export function rnorm(n, mean, sd) {
 ...
 */
export function dunif(x, min, max) {
    x = this._v(x, "r");
    min = this._v(min, "r", 0);
    max = this._v(max, "r", 1);
 ...
 * @returns {Array} Random variates array
 */
export function runif(n, min, max) {
    n = this._v(n, "n");
    min = this._v(min, "r", 0);
    max = this._v(max, "r", 1);
    if(min > max) throw new Error("Minimum value cannot be greater than maximum value");
 ...
 */
export function rword(len, alphabet) {
    len = this._v(len, "n");
 ...
 */
export function sample(collection, n, replace, ratios) {
 ...
 * @private
 */
export function _getCumulativeProbs(ratios, len) {
...
export function _sampleOneIndex(cumulativeProbs) {
...
export function _v(param, type, defaultParam) {
 ...
 */
export function rfml (n, loc, p, cap, trace) {
    n = this._v(n, "n");
